# NVIDIA NCCL Documentation: Nccl - Collectives
...
<div class="wy-menu wy-menu-vertical" data-spy="affix" role="navigation" aria-label="main navigation">
  ...
  - [Using NCCL](../usage.html)
      - [Creating a Communicator](communicators.html)
          ...
          - [Shrinking a communicator](communicators.html#shrinking-a-communicator)
      ...
      - [Quality of Service](communicators.html#quality-of-service)
      ...
      - [Group Calls](groups.html)
          ...
          - [Group Operation Ordering Semantics](groups.html#group-operation-ordering-semantics)
      ...
      - [User Buffer Registration](bufferreg.html)
          ...
          - [Buffer Registration and PXN](bufferreg.html#buffer-registration-and-pxn)
          - [Memory Allocator](bufferreg.html#memory-allocator)
          - [Window Registration](bufferreg.html#window-registration)
          - [Zero-CTA Optimization](bufferreg.html#zero-cta-optimization)
      - [Device-Initiated Communication](deviceapi.html)
          - [Device API](deviceapi.html#device-api)
          - [Host-Side Setup](deviceapi.html#host-side-setup)
          - [Simple LSA Kernel](deviceapi.html#simple-lsa-kernel)
          - [Multimem Device Kernel](deviceapi.html#multimem-device-kernel)
          - [Thread Groups](deviceapi.html#thread-groups)
          - [Teams](deviceapi.html#teams)
          - [GIN Device Kernel](deviceapi.html#gin-device-kernel)
  - [NCCL API](../api.html)
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  - [Using NCCL](../usage.html) »
  - Collective Operations
  - [View page source](../_sources/usage/collectives.rst.txt)
...
<div id="collective-operations" class="section">

# Collective Operations[¶](#collective-operations "Permalink to this headline")
...
<div id="allreduce" class="section">

<span id="id1"></span>

## AllReduce[¶](#allreduce "Permalink to this headline")
...
<div id="id9" class="figure align-center">

<span class="image">../\_images/allreduce.png</span>

<span class="caption-text">All-Reduce operation: each rank receives the reduction of input values across ranks.</span>
...
## Broadcast[¶](#broadcast "Permalink to this headline")

The Broadcast operation copies an N-element buffer from the root rank to all the ranks.

<div id="id10" class="figure align-center">

<span class="image">../\_images/broadcast.png</span>

<span class="caption-text">Broadcast operation: all ranks receive data from a “root” rank.</span>
...
## Reduce[¶](#reduce "Permalink to this headline")
...
<div id="id11" class="figure align-center">

<span class="image">../\_images/reduce.png</span>

<span class="caption-text">Reduce operation: one rank receives the reduction of input values across ranks.</span>
...
<div id="allgather" class="section">

<span id="id4"></span>

## AllGather[¶](#allgather "Permalink to this headline")
...
<div id="id12" class="figure align-center">

<span class="image">../\_images/allgather.png</span>

<span class="caption-text">AllGather operation: each rank receives the aggregation of data from all ranks in the order of the ranks.</span>
...
<div id="reducescatter" class="section">

<span id="id5"></span>

## ReduceScatter[¶](#reducescatter "Permalink to this headline")
...
<div id="id13" class="figure align-center">

<span class="image">../\_images/reducescatter.png</span>

<span class="caption-text">Reduce-Scatter operation: input values are reduced across ranks, with each rank receiving a subpart of the result.</span>
...
<div id="alltoall" class="section">

<span id="id6"></span>

## AlltoAll[¶](#alltoall "Permalink to this headline")
...
<div id="id14" class="figure align-center">

<span class="image">../\_images/alltoall.png</span>

<span class="caption-text">AlltoAll operation: exchanges data between all ranks, where each rank sends different data to every other rank and receives different data from every other rank.</span>
...
<div id="gather" class="section">

<span id="id7"></span>

## Gather[¶](#gather "Permalink to this headline")

The Gather operation gathers N values from k ranks into an output buffer on the root rank of size k\*N.

<div id="id15" class="figure align-center">

<span class="image">../\_images/gather.png</span>

<span class="caption-text">Gather operation: root rank receives data from all ranks.</span>
...
## Scatter[¶](#scatter "Permalink to this headline")

The Scatter operation distributes a total of N\*k values from the root rank to k ranks, each rank receiving N values.

<div id="id16" class="figure align-center">

<span class="image">../\_images/scatter.png</span>

<span class="caption-text">Scatter operation: root rank distributes data to all ranks.</span>
...
[Next <span class="fa fa-arrow-circle-right"></span>](data.html "Data Pointers") [<span class="fa fa-arrow-circle-left"></span> Previous](communicators.html "Creating a Communicator")
